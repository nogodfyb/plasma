package com.fyb.plasma.listener;
...
public class UploadRecipeListener extends AnalysisEventListener<RecipeExcelVo> {
    private static final Logger LOGGER =
            LoggerFactory.getLogger(UploadRecipeListener.class);
    /**
     * 每隔5条存储数据库，实际使用中可以3000条，然后清理list ，方便内存回收
     */
    private static final int BATCH_COUNT = 5;
    List<RecipeExcelVo> list = new ArrayList<RecipeExcelVo>();
    /**
     ...
     * @param recipeService
     */
    public UploadRecipeListener(IRecipeService recipeService) {
     ...
     */
    @Override
    public void invoke(RecipeExcelVo data, AnalysisContext context) {
